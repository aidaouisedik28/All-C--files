...
{
	#region MEMFAHIM1
	public class FahimMemory
	{
		[DllImport("kernel32.dll")]
		private static extern void GetSystemInfo(out FahimMemory.SYSTEM_INFO lpSystemInfo);
		[DllImport("kernel32.dll")]
		public static extern IntPtr OpenProcess(uint dwDesiredAccess, bool bInheritHandle, int dwProcessId);
		[DllImport("kernel32")]
		public static extern bool IsWow64Process(IntPtr hProcess, out bool lpSystemInfo);
		[DllImport("kernel32.dll")]
		private static extern bool VirtualProtectEx(IntPtr hProcess, UIntPtr lpAddress, IntPtr dwSize, FahimMemory.FahimMemoryProtection flNewProtect, out FahimMemory.FahimMemoryProtection lpflOldProtect);
		[DllImport("kernel32.dll")]
		private static extern bool WriteProcessFahimMemory(IntPtr hProcess, UIntPtr lpBaseAddress, byte[] lpBuffer, UIntPtr nSize, IntPtr lpNumberOfBytesWritten);
		[DllImport("kernel32.dll")]
		private static extern bool ReadProcessFahimMemory(IntPtr hProcess, UIntPtr lpBaseAddress, [Out] byte[] lpBuffer, UIntPtr nSize, IntPtr lpNumberOfBytesRead);
		[DllImport("kernel32.dll")]
		public static extern int CloseHandle(IntPtr hObject);
		[DllImport("kernel32.dll", EntryPoint = "VirtualQueryEx")]
		public static extern UIntPtr Native_VirtualQueryEx(IntPtr hProcess, UIntPtr lpAddress, out FahimMemory.MEMORY_BASIC_INFORMATION64 lpBuffer, UIntPtr dwLength);
		[DllImport("kernel32.dll", EntryPoint = "VirtualQueryEx")]
		public static extern UIntPtr Native_VirtualQueryEx(IntPtr hProcess, UIntPtr lpAddress, out FahimMemory.MEMORY_BASIC_INFORMATION32 lpBuffer, UIntPtr dwLength);
		[DllImport("kernel32.dll", CharSet = CharSet.Unicode)]
		private static extern uint GetPrivateProfileString(string lpAppName, string lpKeyName, string lpDefault, StringBuilder lpReturnedString, uint nSize, string lpFileName);
		[DllImport("kernel32.dll")]
		private static extern bool ReadProcessFahimMemory(IntPtr hProcess, UIntPtr lpBaseAddress, [Out] IntPtr lpBuffer, UIntPtr nSize, out ulong lpNumberOfBytesRead);
		public string LoadCode(string name, string file)
		{
			...
			if (flag)
			{
				uint privateProfileString = FahimMemory.GetPrivateProfileString("codes", name, "", stringBuilder, (uint)stringBuilder.Capacity, file);
			}
			else
			{
        ...
        public byte[] ReadME(string code, long length, string file = "")
        {
            ...
            bool flag = !FahimMemory.ReadProcessFahimMemory(this.pHandle, code2, array, (UIntPtr)(checked((ulong)length)), IntPtr.Zero);
            byte[] result;
            if (flag)
            {
                result = null;
        ...
        public Task<IEnumerable<long>> AoBScan(long start, long end, string search, bool readable, bool writable, bool executable, string file = "")
		{
			...
			{
				List<FahimMemoryRegionResult> list = new List<FahimMemoryRegionResult>();
				...
				FahimMemory.SYSTEM_INFO system_INFO = default(FahimMemory.SYSTEM_INFO);
				FahimMemory.GetSystemInfo(out system_INFO);
				...
				FahimMemory.MEMORY_BASIC_INFORMATION memory_BASIC_INFORMATION = default(FahimMemory.MEMORY_BASIC_INFORMATION);
				while (this.VirtualQueryEx(this.pHandle, uintPtr, out memory_BASIC_INFORMATION).ToUInt64() != 0UL && uintPtr.ToUInt64() < (ulong)end && uintPtr.ToUInt64() + (ulong)memory_BASIC_INFORMATION.RegionSize > uintPtr.ToUInt64())
				{
					...
					{
						FahimMemoryRegionResult item2 = new FahimMemoryRegionResult
						{
						...
						if (flag12)
						{
							FahimMemoryRegionResult memoryRegionResult = list[list.Count - 1];
							...
							if (flag13)
							{
								list[list.Count - 1] = new FahimMemoryRegionResult
								{
				...
				Parallel.ForEach<FahimMemoryRegionResult>(list, delegate (FahimMemoryRegionResult item, ParallelLoopState parallelLoopState, long index)
				{
		...
		public void CloseProcess()
		{
			...
			if (!flag)
			{
				FahimMemory.CloseHandle(this.pHandle);
				this.theProc = null;
			}
		}
		...
		private unsafe long[] CompareScan(FahimMemoryRegionResult item, byte[] aobPattern, byte[] mask)
		{
			...
			ulong num;
			FahimMemory.ReadProcessFahimMemory(this.pHandle, item.CurrentBaseAddress, intPtr, (UIntPtr)((ulong)item.RegionSize), out num);
		...
		public UIntPtr VirtualQueryEx(IntPtr hProcess, UIntPtr lpAddress, out FahimMemory.MEMORY_BASIC_INFORMATION lpBuffer)
		{
			bool flag = this.Is64Bit || IntPtr.Size == 8;
			UIntPtr result;
			if (flag)
			{
				FahimMemory.MEMORY_BASIC_INFORMATION64 memory_BASIC_INFORMATION = default(FahimMemory.MEMORY_BASIC_INFORMATION64);
				UIntPtr uintPtr = FahimMemory.Native_VirtualQueryEx(hProcess, lpAddress, out memory_BASIC_INFORMATION, new UIntPtr((uint)Marshal.SizeOf(memory_BASIC_INFORMATION)));
			...
			{
				FahimMemory.MEMORY_BASIC_INFORMATION32 memory_BASIC_INFORMATION2 = default(FahimMemory.MEMORY_BASIC_INFORMATION32);
				UIntPtr uintPtr = FahimMemory.Native_VirtualQueryEx(hProcess, lpAddress, out memory_BASIC_INFORMATION2, new UIntPtr((uint)Marshal.SizeOf(memory_BASIC_INFORMATION2)));
			...
			else
			{
				...
				else
				{
					...
					if (flag6)
					{
						...
						if (flag9)
						{
							FahimMemory.ReadProcessFahimMemory(this.pHandle, (UIntPtr)((ulong)((long)this.mainModule.BaseAddress + array4[0])), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
						}
						else
						{
							...
							if (flag10)
							{
								...
								FahimMemory.ReadProcessFahimMemory(this.pHandle, (UIntPtr)((ulong)((long)value + array4[0])), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
							}
							else
							{
								FahimMemory.ReadProcessFahimMemory(this.pHandle, (UIntPtr)((ulong)array4[0]), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
							}
						}
						...
						for (int j = 1; j < array4.Length; j++)
						{
							...
							FahimMemory.ReadProcessFahimMemory(this.pHandle, uintPtr, array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
				...
				else
				{
					...
					else
					{
						...
						if (flag7)
						{
							...
							if (flag10)
							{
								FahimMemory.ReadProcessFahimMemory(this.pHandle, (UIntPtr)((ulong)((long)((int)this.mainModule.BaseAddress + array4[0]))), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
							}
							else
							{
								...
								if (flag11)
								{
									...
									FahimMemory.ReadProcessFahimMemory(this.pHandle, (UIntPtr)((ulong)((long)((int)value + array4[0]))), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
								}
								else
								{
									FahimMemory.ReadProcessFahimMemory(this.pHandle, (UIntPtr)((ulong)((long)array4[0])), array, (UIntPtr)((ulong)((long)size)), IntPtr.Zero);
								}
							}
		...
		public bool WriteFahimMemory(string code, string type, string write, string file = "", Encoding stringEncoding = null)
		{
			...
			return FahimMemory.WriteProcessFahimMemory(this.pHandle, code2, array, (UIntPtr)((ulong)((long)num)), IntPtr.Zero);
		}
		public bool IsAdmin()
		{
			bool result;
			...
			else
			{
				...
				else
				{
					try
					{
						...
						{
							this.pHandle = FahimMemory.OpenProcess(2035711U, true, pid);
							...
							else
							{
								...
								this.GetModules();
								bool flag6;
								this.Is64Bit = (Environment.Is64BitOperatingSystem && FahimMemory.IsWow64Process(this.pHandle, out flag6) && !flag6);
		...
		public bool ChangeProtection(string code, FahimMemory.FahimMemoryProtection newProtection, out FahimMemory.FahimMemoryProtection oldProtection, string file = "")
		{
			UIntPtr code2 = this.GetCode(code, file, 8);
			...
			if (flag)
			{
				oldProtection = (FahimMemory.FahimMemoryProtection)0U;
				result = false;
			}
			else
			{
				result = FahimMemory.VirtualProtectEx(this.pHandle, code2, (IntPtr)(this.Is64Bit ? 8 : 4), newProtection, out oldProtection);
			}
			return result;
		}

        internal object ReadME<T>(string v)
        {
		...
		[Flags]
		public enum FahimMemoryProtection : uint
		{
			Execute = 16U,
			ExecuteRead = 32U,
	...
	internal struct FahimMemoryRegionResult
	{
